...
const ApiServiceContext = createContext<ApiServiceContextValue | undefined>(
    undefined
);

export const ApiServiceProvider: React.FC<ApiServiceContextProps> = ({
    children,
}) => {
...
export function useApiService(): ApiServiceContextValue {
    ...
    if (!context) {
        throw new Error(
            'useApiService must be used within a ApiServiceProvider'
        );
    }
    return context;
}
